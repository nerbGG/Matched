...
urlpatterns = [
    ...
    path("success-stories/", apply_views.stories_view, name="allTheUsersSuccessStories"),
    path("success-stories/<filter>/", apply_views.stories_view, name="allTheUsersSuccessStories"),
